...
?>
<div class="container">
    <h5 class="card-title">Bitumen Extraction Test (Grade 80-100)</h5>
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle table-sm">
                ...
                <tr>
                    ...
                    <th scope="col" colspan="2">Values of 80-100 Bitumen Grade</th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-center">1.01 – 1.05</td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">1.0 Max</td>
                </tr>
                <tr>
